    ...
    <div style={{ minHeight: '100vh', background: '#070707', display: 'flex', fontFamily: "'Satoshi', 'DM Sans', sans-serif" }}>
      ...
      <div style={{ width: '100%', maxWidth: 480, display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '60px 48px', position: 'relative', zIndex: 1 }}>
        <div style={{ marginBottom: 40 }}>
          <div style={{ fontFamily: "'Cabinet Grotesk', sans-serif", fontSize: 22, fontWeight: 800, marginBottom: 32, display: 'none' }}>VYRA<span style={{ color: '#F5A623' }}>.</span></div>
          <h1 style={{ fontFamily: "'Cabinet Grotesk', sans-serif", fontSize: 32, fontWeight: 800, color: '#fff', marginBottom: 8, letterSpacing: '-0.02em' }}>Welcome back</h1>
